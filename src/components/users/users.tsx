...
import newdollar from "../../assets/img/dollar-symbol-money-svgrepo-com.svg";
import newbitcoin from "../../assets/img/bitcoin-svgrepo-com.svg";
import new24hrs from "../../assets/img/24-hours-svgrepo-com.svg";
import newnetwork from "../../assets/img/graphs-svgrepo-com.svg";
import {
  TrendingUp,
  TrendingDown,
  X,
      ...
      <div className="flex items-center">
        <div className="flex items-center space-x-3 md:space-x-4">
          <div className="relative">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#FEFD0C] to-[#FEFD0C]/80 rounded-full flex items-center justify-center shadow-lg">
...
<div className={`fixed md:relative inset-y-0 left-0 z-50 ${showLabels ? 'w-64' : 'w-20'} ${theme.background} border-r border-[#FEFD0C]/10 flex flex-col font-poppins transform transition-all duration-300 ease-in-out ${
  ...
  <nav className="flex-1 p-4 md:p-6">
    <ul className="list-none p-0 mt-2 md:mt-4">
      <NavItem
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 relative z-10">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-1 mt-1 md:mt-2">
                    ...
                    <span className="text-xs font-medium text-black font-poppins">
                      {marketStats.totalMarketCapChange >= 0 ? '+' : ''}
                      {marketStats.totalMarketCapChange.toFixed(2)}%
                    </span>
                  </div>
                </div>
                <img src={newdollar} alt="MarketCap" className="w-5 h-5 md:w-7 md:h-7 text-black"/>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center space-x-1 mt-1 md:mt-2">
                    ...
                    <span className="text-xs font-medium text-black font-poppins">
                      {marketStats.tradingVolumeChange >= 0 ? '+' : ''}
                      {marketStats.tradingVolumeChange.toFixed(2)}%
                    </span>
                  </div>
                </div>
                <img src={new24hrs} alt="24h volume" className="w-6 h-6 md:w-8 md:h-8 text-black"/>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center space-x-1 mt-1 md:mt-2">
                    ...
                    <span className="text-xs font-medium text-black font-poppins">
                      {marketStats.btcDominanceChange >= 0 ? '+' : ''}
                      {marketStats.btcDominanceChange.toFixed(2)}%
                    </span>
                  </div>
                </div>
                <img src={newbitcoin} alt="Btc Dominance" className="w-6 h-6 md:w-8 md:h-8 text-black"/>
              </div>
            </div>
            ...
            <div className="bg-[#FEFD0C] text-black rounded-lg md:rounded-xl p-4 md:p-6 border border-black shadow-2xl shadow-black/40">
              <div className="flex items-center justify-between">
                ...
                <img src={newnetwork} alt="Active Cryptos" className="w-6 h-6 md:w-8 md:h-8 text-black"/>
              </div>
            </div>
          </div>
